...
class FooocusExpansion:
    def __init__(self):
        ...
        printF(name=MasterName.get_master_name(), info="Fooocus V2 Expansion: Vocab with {} words.".format(len(debug_list))).printf()
        ...
        printF(name=MasterName.get_master_name(), info="Fooocus Expansion engine loaded for {}, use_fp16 = {}.".format(
            load_device, use_fp16)).printf()
