...
from adapter.parameters import ImageGenerationParams, ImageGenerationResult, GenerationFinishReason
...
class QueueTask(object):
    ...
    def __init__(self, job_id: str = "", type: TaskType = None, req_param: ImageGenerationParams = None,
                 in_queue_millis: int = 1,
    ...
    def set_result(self, task_result: List[ImageGenerationResult], finish_with_error: bool,
                   error_message: str | None = None):
...
class TaskQueue(object):
    ...
    def __init__(self, queue_size: int = 1, hisotry_size: int = 1, webhook_url: str | None = None,
    ...
    def add_task(self, type: TaskType, req_param: ImageGenerationParams,
