...
class AttnBlock(nn.Module):
    def __init__(self, in_channels):
        ...
        if model_management.xformers_enabled_vae():
            ...
            printF(name=MasterName.get_master_name(), info="Using pytorch attention in VAE").printf()
            self.optimized_attention = pytorch_attention
        else:
            printF(name=MasterName.get_master_name(), info="Using split attention in VAE").printf()
...
class Decoder(nn.Module):
    def __init__(self, *, ch, out_ch, ch_mult=(1, 2, 4, 8), num_res_blocks,
        ...
        printF(name=MasterName.get_master_name(), info="Working with z of shape {} = {} dimensions.".format(
            self.z_shape, np.prod(self.z_shape))).printf()
