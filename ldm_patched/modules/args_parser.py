...
parser.add_argument("--default-hashing-function", type=str, choices=['md5', 'sha1', 'sha256', 'sha512'],
                    default='sha256',
...
parser.add_argument("--force-channels-last", action="store_true",
...
parser.add_argument("--reserve-vram", type=float, default=None,
