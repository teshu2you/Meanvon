...
def model_config_from_unet(state_dict, unet_key_prefix, dtype, use_base_if_no_match=False):
    ...
    printF(name=MasterName.get_master_name(), info="[unet_config] = {}".format(unet_config)).printf()

    model_config = model_config_from_unet_config(unet_config)
    printF(name=MasterName.get_master_name(), info="[model_config] = {}".format(model_config)).printf()
