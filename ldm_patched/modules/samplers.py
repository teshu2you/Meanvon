...
def calculate_sigmas_scheduler(model_sampling, scheduler_name, steps):
    if scheduler_name == "karras":
        ...
        printF(name=MasterName.get_master_name(), info="error invalid scheduler {}".format(scheduler_name)).printf()
    return sigmas
