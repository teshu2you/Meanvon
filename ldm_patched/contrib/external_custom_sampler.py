...
import ldm_patched.latent_preview
import torch
import ldm_patched.modules.utils
import ldm_patched.node_helpers
...
class BasicScheduler:
    ...
    def get_sigmas(self, model, scheduler, steps, denoise):
        ...
        sigmas = ldm_patched.modules.samplers.calculate_sigmas_scheduler(model.get_model_object("model_sampling"), scheduler, total_steps).cpu()
...
class SamplerCustom:
    ...
    def sample(self, model, add_noise, noise_seed, cfg, positive, negative, sampler, sigmas, latent_image):
        ...
        x0_output = {}
        callback = ldm_patched.latent_preview.prepare_callback(model, sigmas.shape[-1] - 1, x0_output)
...
class Guider_DualCFG(ldm_patched.modules.samplers.CFGGuider):
    ...
    def set_conds(self, positive, middle, negative):
        middle =ldm_patched.node_helpers.conditioning_set_values(middle, {"prompt_type": "negative"})
...
class SamplerCustomAdvanced:
    ...
    def sample(self, noise, guider, sampler, sigmas, latent_image):
        ...
        x0_output = {}
        callback = ldm_patched.latent_preview.prepare_callback(guider.model_patcher, sigmas.shape[-1] - 1, x0_output)
