...
def listen():
    GENERATE_BUTTON.click(
        generate_audio,
        outputs=[get_component('original_audio_output'), get_component('enhanced_audio_output'),
                 get_component('text_output')]
    )
...
def generate_audio():
    ...
    original_audio_output, enhanced_audio_output, text = audio_pre_processor(audio_pre_Process_Params, enhance_parms,
                                                                             CHAT)
    # text=''
